...
function Card ({ id, title, imageUrl,country,videoUrl }: cardProps) {
    ...
    <div className="rounded-lg w-64 h-100 flex flex-col items-center gap-2 font-sans animate-fade-in card hover:animate-slide-out-top">
        ...
        <div className="mt-auto justify-between flex w-full items-center p-2.5">
            {videoUrl=== ""? "" : <a href={videoUrl} target="_blank" className="video rounded-lg p-1  hover:animate-pulsing hover:animate-iteration-count-infinite hover:bg-sky-500"> video </a>}
